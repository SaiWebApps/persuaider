...
export function LoginForm({ oauthProviders = [] }: { oauthProviders?: Array<{ id: string; name: string }> }) {
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 pr-12 border border-gray-300 dark:border-gray-600 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-gray-100 dark:bg-gray-700 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 z-20 pr-3 flex items-center text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 focus:outline-none"
                tabIndex={-1}
              >
                {showPassword ? (
